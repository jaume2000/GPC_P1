...
function loadScene(){
    ...
    //Suelo
    suelo = new THREE.Mesh(new THREE.PlaneGeometry(500,500, 100,100),default_material)
...
function activate_wires(bool_val){
    ...
    if(bool_val){
        ...
        recursive_set_material(robot, default_material)
        suelo.material = default_material
    }
}
